...
local function funpack(gen_x, param_x, state_x)
  local state_x, val = gen_x(param_x, state_x)
  if state_x == nil then return end
  return val, funpack(gen_x, param_x, state_x)
end
methods.unpack = method0(funpack)
exports.unpack = export0(funpack)
